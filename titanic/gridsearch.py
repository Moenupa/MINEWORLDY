...
def main():
    ...
    param_dict = {
        ...
        'max_samples':[i for i in range(1,5)],
        'max_features': [i for i in range(1,5)],
    }
    classifier = BaggingClassifier(base_estimator=RandomForestClassifier(n_estimators=340, max_depth=9, random_state=0, min_samples_split=2, min_samples_leaf=2, min_weight_fraction_leaf=0))
